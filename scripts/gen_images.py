...
STYLE_PREFIX = (
    "Реалистичная качественная фотография: живые, естественно выглядящие молодые люди "
    "(студенты) в современной обстановке, мягкий натуральный свет, неглубокая глубина "
    "резкости, профессиональная editorial-съёмка, фотореализм. Фирменные синие акценты "
    "(#13445D, #1A5CA8) в одежде и интерьере. Обычная современная техника, без футуристики "
    "и голограмм. На изображении НЕТ текста, букв, надписей, логотипов и цифр. "
)
