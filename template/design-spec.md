...
- ЕДИНАЯ ШИРИНА всех full-width элементов: hero-картинка, карточка-таймлайн (roadmap),
  карточка «Как устроен» (TOCBox), плашки — ВСЕ ровно `cx="7223760"` EMU, чтобы левые/правые
  края совпадали. Любую full-width картинку приводить к 7223760 (высота пропорционально).
  Частый баг: таймлайн «Дорога к поступлению» бывает у́же (6858000) — выровнять до 7223760.
